...
<div class="cta-box">
  ...
  <p>Es gibt zwei Versionen von AddressHero, die sich an verschiedene Bedürfnisse richten:</p>
  
  <div class="pricing-cards">
    <div class="pricing-card">
      <h4>AddressHero Pro</h4>
      <div class="price">Kostenlose Installation</div>
      <div class="price-detail">14 Tage kostenlos, dann $0,04 pro Bestellung</div>
      <ul>
        <li>Vollständige Adressvalidierung</li>
        <li>Prüfung auf Leitcodierbarkeit</li>
        <li>Kompatibel mit Express Checkouts</li>
        <li>Automatische Adressvorschläge</li>
        <li>E-Mail & Klaviyo Integration</li>
      </ul>
    </div>
    
    <div class="pricing-card">
      <h4>AddressHero Lite</h4>
      <div class="price">$9.99 / Monat</div>
      <div class="price-detail">14-tägiger kostenloser Test</div>
      <ul>
        <li>Läuft mit jedem Shopify Tarif</li>
        <li>Blocke Adressen ohne Hausnummer</li>
        <li>Packstationen prüfen oder blockieren</li>
        <li>Blocke Adresse mit Sonderzeichen</li>
      </ul>
    </div>
  </div>
